...
export async function querySummary(query, userQuery) {
...
async function main() {
    try {
        // Updating status at different stages
        ...
        const dataScraped = await scrapeUrls(extractedUrls.slice(0, 50)); // Limit to 50 URLs
